...
- [**nestjs-jwt-guard**](https://github.com/onury/nestjs-jwt-guard) — bearer-JWT authentication for NestJS — a configurable guard, `@Public()`, and a token-issuance helper.
- [**nestjs-oauth2-password**](https://github.com/onury/nestjs-oauth2-password) — OAuth2 ROPC for NestJS — opaque, server-stored, revocable access + refresh tokens and an RFC 6749 token endpoint.
